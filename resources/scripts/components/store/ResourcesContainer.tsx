    ...
    return (
        <PageContentBlock title={'商店商品'} showFlashKey={'store:resources'}>
            ...
            <Container className={'j-up lg:grid lg:grid-cols-3 my-10'}>
                ...
                <TitledGreyBox title={'购买 RAM 运行内存'} css={tw`mt-8 sm:mt-0 sm:ml-8`}>
                    <Wrapper>
                    ...
                    <p css={tw`mt-1 text-gray-500 text-xs flex justify-center`}>
                        每 1GB RAM: {cost.memory} {currency}
                    </p>
                </TitledGreyBox>
            ...
            <Container className={'j-up lg:grid lg:grid-cols-4 my-10'}>
                <TitledGreyBox title={'购买服务器位'} css={tw`mt-8 sm:mt-0`}>
                    <Wrapper>
                        <Icon.Server size={40} />
                        <Button.Success
                            variant={Button.Variants.Secondary}
                ...
                <TitledGreyBox title={'购买服务器端口'} css={tw`mt-8 sm:mt-0 sm:ml-8`}>
                    ...
                    <p css={tw`mt-1 text-gray-500 text-xs flex justify-center`}>
                        每 1 个端口: {cost.port} {currency}
                    </p>
                </TitledGreyBox>
                <TitledGreyBox title={'购买服务器备份位'} css={tw`mt-8 sm:mt-0 sm:ml-8`}>
                    <Wrapper>
                ...
                <TitledGreyBox title={'购买服务器数据库'} css={tw`mt-8 sm:mt-0 sm:ml-8`}>
                    ...
                    <p css={tw`mt-1 text-gray-500 text-xs flex justify-center`}>
                        每 1 个数据库: {cost.database} {currency}
                    </p>
                </TitledGreyBox>
            </Container>
        </PageContentBlock>
