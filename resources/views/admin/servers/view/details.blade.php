        ...
        <div class="box box-primary">
            ...
            <form action="{{ route('admin.servers.view.details', $server->id) }}" method="POST">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="renewable" class="control-label">可续订 <span class="field-required"></span></label>
                        ...
                        <p class="text-muted small">决定服务器是否可以让用户自行续订而不是只能一次性使用.</p>
                    </div>
                    <div class="form-group">
                        ...
                        <p class="text-muted small">设置用户使用多长时间才需要重新付费续订.</p>
                    </div>
                </div>
