...
return [
    ...
    'user' => [
        'account' => [
			...
			'username-changed' => '已更改旧用户名 :old 至 :new',
        ],
        'api-key' => [
        ...
        'store' => [
            'resource-purchase' => '已成功购买此资源',
        ],
    ],
    'server' => [
        'reinstall' => '重新安装服务器实例',
        'console' => [
            'command' => '于此服务器上执行了指令 ":command" ',
        ],
        'power' => [
            'start' => '已启动服务器',
            'stop' => '已停止服务器',
        ...
        'sftp' => [
            ...
            'rename_one' => '重命名了文件 :files.0.至 :files.0.to',
